import { AvatarType, DialogType, MapStateToPropsType, MessageType } from "../../components/Dialogs/DialogsContainer";
...
const dialogsReducer = (state: DialogsStateType = initialState, action: any): MapStateToPropsType => {
  switch (action.type) {
